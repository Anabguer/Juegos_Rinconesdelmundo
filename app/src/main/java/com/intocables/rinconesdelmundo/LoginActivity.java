...
public class LoginActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // Verificar si el usuario ya tiene nick configurado
                            checkUserNick(user);
                        } else {
    ...
    private void checkUserNick(FirebaseUser user) {
        // Verificar si el usuario ya tiene nick configurado
        // Por simplicidad, siempre vamos a la pantalla de nick
        // En una implementación real, verificarías en Firestore si ya tiene nick
