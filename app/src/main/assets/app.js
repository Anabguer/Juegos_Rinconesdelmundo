...
class RinconesDelMundo {
    ...
    async loadPuzzlesConfig() {
        try {
            ...
            if (window.Android && window.Android.loadAsset) {
                ...
                const response = await fetch('data/puzzles_config.json');
                if (!response.ok) {
    ...
    initAudio() {
        try {
            ...
            this.audio.background = new Audio('assets/audio/background.mp3');
            this.audio.background.volume = 0.2;
            this.audio.background.loop = true;
            this.audio.background.preload = 'auto';
            
            this.audio.move = new Audio('assets/audio/move.mp3');
            this.audio.move.volume = 0.3;
            this.audio.move.preload = 'auto';
            
            this.audio.complete = new Audio('assets/audio/complete.mp3');
